 ...
 Ambiente bem organizado, a barbearia tem como objetivo conquistar uma base sólida de clientes fidelizados e, em longo prazo, se tornar referência no setor, com potencial de expansão por meio do modelo de franquias. 
    ...
    <section class="values">
      ...
      <article class="value-card">
        <h3>Missão</h3>
        <p>Sempre ter um local conhecido por sua limpeza, autoestima e qualidade, mantendo um preço justo, mas ideal pela nossa competência.</p>
      </article>

      <article class="value-card">
        <h3>Visão</h3>
        <p>Ser reconhecida como a melhor barbearia de São Bernardo do Campo e poder, a longo prazo, transformar o nosso negócio em uma rede de franquias.</p>
      </article>
    </section>
